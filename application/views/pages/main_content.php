    ...
    <div class="widget span3 red" onTablet="span6" onDesktop="span3">
        ...
        <div class="content">
            ...
            <div class="browserStat big">
                <img src="src/img/browser-chrome-big.png" alt="Chrome">
                <span>34%</span>
            </div>
            <div class="browserStat big">
                <img src="src/img/browser-firefox-big.png" alt="Firefox">
                <span>34%</span>
            </div>
            <div class="browserStat">
                <img src="src/img/browser-ie.png" alt="Internet Explorer">
                <span>34%</span>
            </div>
            <div class="browserStat">
                <img src="src/img/browser-safari.png" alt="Safari">
                <span>34%</span>
            </div>
            <div class="browserStat">
                <img src="src/img/browser-opera.png" alt="Opera">
                <span>34%</span>
            </div>	
    ...
    <div class="box black span4" onTablet="span6" onDesktop="span4">
        ...
        <div class="box-content">
            <ul class="dashboard-list metro">
                <li class="green">
                    <a href="#">
                        <img class="avatar" alt="Lucas" src="src/img/avatar.jpg">
                    </a>
                ...
                <li class="yellow">
                    <a href="#">
                        <img class="avatar" alt="Bill" src="src/img/avatar9.jpg">
                    </a>
                ...
                <li class="red">
                    <a href="#">
                        <img class="avatar" alt="Jane" src="src/img/avatar5.jpg">
                    </a>
                ...
                <li class="blue">
                    <a href="#">
                        <img class="avatar" alt="Kate" src="src/img/avatar6.jpg">
                    </a>
