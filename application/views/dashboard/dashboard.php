                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown hidden-phone">
                                ...
                                <ul class="dropdown-menu messages">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="avatar"><img src="src/img/avatar.jpg" alt="Avatar"></span>
                                            <span class="header">
                                                <span class="from">
                                                    Łukasz Holeczek
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="avatar"><img src="src/img/avatar2.jpg" alt="Avatar"></span>
                                            <span class="header">
                                                <span class="from">
                                                    Megan Abott
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="avatar"><img src="src/img/avatar3.jpg" alt="Avatar"></span>
                                            <span class="header">
                                                <span class="from">
                                                    Kate Ross
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="avatar"><img src="src/img/avatar4.jpg" alt="Avatar"></span>
                                            <span class="header">
                                                <span class="from">
                                                    Julie Blank
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="avatar"><img src="src/img/avatar5.jpg" alt="Avatar"></span>
                                            <span class="header">
                                                <span class="from">
                                                    Jane Sanders
                                                </span>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php base_url()?>admin-panel"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
                            <li><a href="<?php base_url()?>add-student"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Student</span></a></li>
                            <li><a href="<?php base_url()?>manage-student"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Student</span></a></li>
                            <li><a href="<?php base_url()?>add-admin"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Admin</span></a></li>
